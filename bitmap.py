...
class Bitmap:
    ...
    # --------------------------------------------------
    # Loading Methods: load via FileUtils + import_pillow
    # --------------------------------------------------
    ...
    def with_image(cls, file_path) -> "Bitmap":
        ...
        an explicit file path via FileUtils.load_image.
        """
        bmp = cls()
    ...
    def with_local_image(
        ...
        FileUtils.load_local_image (which uses FileUtils.local for path building).
        """
        bmp = cls()
    ...
    def load_image(self, file_path):
        """
        Create a Bitmap from an explicit file path using FileUtils.load_image.
        """
    ...
    def load_local_image(
        ...
        """
        Create a Bitmap using FileUtils.load_local_image
        (which uses FileUtils.local for path building).
        """
